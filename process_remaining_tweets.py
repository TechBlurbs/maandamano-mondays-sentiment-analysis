...
def _find_unprocessed_tweets(raw_tweets, processed_ids, processed_texts):
...
def _label_tweets(unprocessed_tweets):
    """Apply simple rule-based sentiment labels to a list of tweets."""
    newly_processed = []
...
def process_remaining_tweets():
    ...
    newly_processed = _label_tweets(unprocessed_tweets)
